...
if ($authResult === false) {
	...
	tpl_map();
	tpl_footer(array('js/intel_settings.js', 'js/intel_map.js', 'js/intel_map_poll.js', 'js/intel_map_jb.js', 'js/intel_map_draw.js', 'js/intel_map_reports.js', 'js/intel_map_logs.js'));
	return;
    }
